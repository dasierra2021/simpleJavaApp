...
public class CalculatorUI {
    ...
    /**
     * Constructs a new instance of the CalculatorUI class.
    ...
    /**
     * Calculates the result of a binary operation based on the selected operator.
     *
    ...
    /**
     * Initializes the input screen, setting its properties and appearance.
     *
     * @param columns The horizontal positions for layout.
     * @param rows    The vertical positions for layout.
     */
    ...
    /**
     * Initializes the calculator type selector dropdown and sets up the event listener for type changes.
     */
    ...
    /**
     * Initializes the buttons on the calculator UI, setting properties, appearance, and event listeners.
     *
     * @param columns The horizontal positions for layout.
     * @param rows    The vertical positions for layout.
     */
    ...
    /**
     * Creates a JComboBox (dropdown) with specified items, positions it, and sets up event listeners.
     *
     * @param items   The array of items for the dropdown.
     * @param x       The horizontal position.
     * @param y       The vertical position.
     * @param toolTip The tooltip for the dropdown.
    ...
    /**
     * Creates a JButton with specified label, positions it, and sets up appearance and event listeners.
     *
    ...
    /**
     * Applies the selected theme to the entire calculator UI.
     *
